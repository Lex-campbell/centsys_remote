"""Country dialing codes for the setup form (mirrors the app's picker).

Generated from ISO 3166-1 regions and their E.164 country calling codes.
Each entry is ``(iso_alpha2, display_name, dial_code)``.
"""
